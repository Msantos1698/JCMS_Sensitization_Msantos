...
d1 <- as.data.table(read_xlsx(filename, sheet = 1)) # Read the first worksheet and convert it to a data.table.
...
Problem animal
AnimalName: 021205_B6NJ−Macrod2_Cyfip2_S968F_F_21894
MouseID: 021205
